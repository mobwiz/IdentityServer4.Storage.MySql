...
namespace IdentityServer4.Storage.Mysql.Mapper
{
    ...
    public static class ScopeMappers
    {
        ...
        /// <returns></returns>
        public static Models.ApiScope ToModel(this ApiScopeDO entity)
        {
        ...
        /// <returns></returns>
        public static ApiScopeDO ToEntity(this Models.ApiScope model)
        {
            return model == null ? null : Mapper.Map<ApiScopeDO>(model);
        }
    }
}
